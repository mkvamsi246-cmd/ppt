  ...
  return (
    <SectionWrapper id="adaptive">
      <div className="max-w-7xl mx-auto px-2.5 sm:px-6 w-full flex-1 flex flex-col justify-start sm:justify-between gap-3 py-1 sm:py-2">
        ...
        <div className="rounded-2xl relative overflow-hidden bg-gradient-to-b from-slate-100 to-slate-50 border border-slate-200 h-[160px] sm:h-[190px] shadow-inner my-1 sm:my-2">
